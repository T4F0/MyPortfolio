...
export const featuredProjects = [
  ...
  {
    eyebrow: "Cybersecurity Research & Full-Stack ML Application",
    title: "Lightweight NIDS with Zeek + Machine Learning",
    description:
      "A two-tier Network Intrusion Detection System combining Zeek deep-packet inspection with a LightGBM + CatBoost ensemble trained on 1.2M flows from CIC-IDS2017, achieving 99.6% anomaly recall and 99.97% weighted F1 on attack classification — featuring a confidence-based zero-day detection gate that flags novel attacks without retraining, per-alert SHAP explainability with ranked feature importance, an O(n) sliding-window feature engine computing 22 behavioral signals across connection, DNS, HTTP, and TLS layers, dual offline (PCAP forensics) and live (streaming interface) operating modes, and a full-stack web dashboard with PCAP upload, async job tracking, live capture control, and model introspection — all backed by a Flask REST API and a React/Vite frontend.",
    callout:
      "Two-tier ML ensemble, zero-day confidence gating, SHAP per-alert explanations, 22-feature Zeek extraction, live & offline detection modes, full-stack web dashboard",
    role: "My Role · ML Engineer, Full-Stack Developer & Zeek Integration",
    tech: [
      "Python",
      "LightGBM",
      "CatBoost",
    ...
    reverse: false,
    links: [
      { label: "Repo", href: "https://github.com/Ch1Hub/Lightweight-NIDS-with-Zeek-Machine-Learning", external: true },
      // { label: "Case Study", href: "#work" },
    ],
  },
...
export const frenchData = {
  ...
  featuredProjects: [
    ...
    {
      eyebrow: "Recherche en Cybersécurité & Application Full-Stack ML",
      title: "NIDS Léger avec Zeek + Machine Learning",
      description:
        "Un système de détection d'intrusion réseau à deux niveaux combinant l'inspection approfondie de paquets Zeek avec un ensemble LightGBM + CatBoost entraîné sur 1,2 million de flux CIC-IDS2017, atteignant 99,6 % de rappel d'anomalies et 99,97 % de F1 pondéré pour la classification d'attaques — avec une porte de détection de zero-day basée sur la confiance qui signale les nouvelles attaques sans réentraînement, une explicabilité SHAP par alerte avec importance des fonctionnalités classée, un moteur de fonctionnalités à fenêtre glissante en O(n) calculant 22 signaux comportementaux sur les couches connexion, DNS, HTTP et TLS, des modes de fonctionnement doubles hors ligne (analyse PCAP) et en direct (interface de streaming), et un tableau de bord web full-stack avec upload PCAP, suivi de tâches asynchrones, contrôle de capture en direct et introspection de modèle — le tout soutenu par une API REST Flask et un frontend React/Vite.",
      callout:
        "Ensemble ML à deux niveaux, filtrage de confiance zero-day, explications SHAP par alerte, extraction de 22 fonctionnalités Zeek, modes de détection en direct et hors ligne, tableau de bord web full-stack",
      role: "Mon Rôle · Ingénieur ML, Développeur Full-Stack & Intégration Zeek",
      tech: [
        "Python",
        "LightGBM",
        "CatBoost",
      ...
      media: "teal",
      placeholder: "Capture d'écran du projet — placeholder",
      image: "nids-dashboard.png",
      reverse: false,
      links: [
        // { label: "Repo", href: "#", external: true },
